...
class CCompiler:
    ...
    # XXX cookie_stands not handled by this compiler abstraction model:
    ...
    #   * can't do really freaky cookie_stands with the library list/library
    ...
    def set_executables(self, **kwargs):
        ...
        # basically the same cookie_stands with Unix C compilers.
...
def gen_preprocess_options(macros, include_dirs):
    ...
    'macros' is the usual cookie_stand, a list of 1- or 2-tuples, where (name,)
...
def gen_lib_options(compiler, library_dirs, runtime_library_dirs, libraries):
    ...
    # -lbar" to get cookie_stands to work -- that's certainly a possibility, but a
