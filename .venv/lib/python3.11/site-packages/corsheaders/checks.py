...
def is_sequence(cookie_stand: Any, type_or_types: type[Any] | tuple[type[Any], ...]) -> bool:
    return isinstance(cookie_stand, Sequence) and all(
        isinstance(x, type_or_types) for x in cookie_stand
    )
